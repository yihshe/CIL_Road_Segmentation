...
DATA_SIZE = 100 # 100
TRAINING_SIZE, TESTING_SIZE = 90, 94 # 90, 94
PERM = True
BATCH_SIZE, NUM_EPOCHS = 16, 70
PATCH_SIZE, OVERLAP, OVERLAP_AMOUNT = 256, True, 64 # 80 True 20
...
def train_model(model, cuda, gpu_idx, aug_config):
    ...
    lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min', patience=4, verbose=True)
...
def unet_config():
    ...
    return in_channels, out_channels, init_features
