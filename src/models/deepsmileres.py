...
class UNet(nn.Module):
    ...
    def __init__(self, nbr_layers, channels_sizes):
        ...
        CHANNELS_L5 = channels_sizes['CHANNELS_L5']
        
        self.down1 = DownStep(CHANNELS_L0, CHANNELS_L1, dropout=False)
        self.down2 = DownStep(CHANNELS_L1, CHANNELS_L2, dropout=False)
        self.down3 = DownStep(CHANNELS_L2, CHANNELS_L3, dropout=False)
        self.down4 = DownStep(CHANNELS_L3, CHANNELS_L4, dropout=False)

        self.center = UpStep(CHANNELS_L4, CHANNELS_L5, CHANNELS_L4)

        self.up4 = UpStep(CHANNELS_L5, CHANNELS_L4, CHANNELS_L3)
    ...
    def forward(self, x):
        ...
        down4, bridge4 = self.down4(down3)
        
        center = self.center(down4)
        up4 = self.up4(torch.cat([center, bridge4], 1))
        up3 = self.up3(torch.cat([up4, bridge3], 1))        
...
class UpStep(nn.Module):
    ...
    def __init__(self, in_channels, middle_channels, out_channels, mode='transpose'):
        ...
        self.res = nn.Conv2d(in_channels, middle_channels, kernel_size=1, padding=0)
